...
export const projects: Project[] = [
  {
    title: "Monkey Branch",
    slug: "monkey-branch",
    oneLiner: "Sistemas web corporativos e automação de processos",
    description:
  ...
  },
  {
    ...
    slug: "discord-bots",
    oneLiner: "Bots e automações com Discord.js",
    description:
  ...
  },
  {
    ...
    slug: "mobile-apps",
    oneLiner: "Apps mobile multiplataforma com React Native",
    description:
  ...
  },
  {
    title: "Valocracia",
    slug: "valocracia",
    oneLiner: "Plataforma Web3 de governança descentralizada",
    description:
    ...
    highlights: [
      ...
      "Smart contracts publicados e testados em produção",
      "Integração blockchain ↔ frontend com Ethers.js",
    ],
    caseStudy:
  ...
  {
    title: "HackaNation 2025",
    slug: "hackanation",
    oneLiner: "Campeão do HackaNation 2025 – São Paulo",
    description:
      "Participação e conquista do primeiro lugar no hackathon HackaNation 2025, realizado em São Paulo.",
    stack: ["TypeScript", "Node.js", "React", "TailwindCSS"],
    links: {},
    ...
    highlights: [
      ...
      "Projeto desenvolvido em equipe durante o hackathon",
    ],
  },
];
